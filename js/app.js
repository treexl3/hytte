    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                } else if ("tel" === formRequiredItem.dataset.required) if (this.phoneTest(formRequiredItem)) {
                    this.addError(formRequiredItem);
                    error++;
                } else {
                    this.removeError(formRequiredItem);
            ...
            phoneTest(formRequiredItem) {
                return !/^[0-9+\(\)#\.\s\/ext-]+$/.test(formRequiredItem.value);
            }
        };
        function formSubmit() {
        ...
        class FullPage {
            ...
            setClasses() {
                ...
                for (let index = 0; index < this.sections.length; index++) {
                    const section = this.sections[index];
                    if (section.classList.contains("active-section")) document.documentElement.classList.add(`fp-section-${section.getAttribute("data-fp-id")}`); else document.documentElement.classList.remove(`fp-section-${section.getAttribute("data-fp-id")}`);
                }
            ...
            choiceOfDirection(direction) {
                ...
                if (direction > 0 && false !== this.nextSection) {
                ...
                } else if (direction < 0 && false !== this.previousSection) {
                ...
                if (this.stopEvent) this.switchingSection(this.activeSectionId, direction);
            }
            switchingSection(e = this.activeSectionId, t) {
                if (t || (e < this.activeSectionId ? t = -100 : e > this.activeSectionId && (t = 100)), 
                this.activeSectionId = e, this.stopEvent = !0, (!1 === this.previousSectionId && t < 0 || !1 === this.nextSectionId && t > 0) && (this.stopEvent = !1), 
                this.stopEvent) {
                    let e;
                    document.documentElement.classList.add(this.options.wrapperAnimatedClass), this.wrapper.classList.add(this.options.wrapperAnimatedClass), 
                    this.removeClasses(), this.setClasses(), this.setStyle(), this.options.bullets && this.setActiveBullet(this.activeSectionId), 
                    t < 0 ? (e = this.activeSection.dataset.fpDirectionUp ? parseInt(this.activeSection.dataset.fpDirectionUp) : 500, 
                    document.documentElement.classList.add("fp-up"), document.documentElement.classList.remove("fp-down")) : (e = this.activeSection.dataset.fpDirectionDown ? parseInt(this.activeSection.dataset.fpDirectionDown) : 500, 
                    document.documentElement.classList.remove("fp-up"), document.documentElement.classList.add("fp-down")), 
                    setTimeout((() => {
                        this.events.transitionEnd();
                    }), e), this.options.onSwitching(this), document.dispatchEvent(new CustomEvent("fpswitching", {
                        detail: {
                            fp: this
                        }
                    }));
        ...
        function documentActions(e) {
            ...
            if ((targetElement.closest(".header__logo") || targetElement.classList.contains(".header__logo")) && !htmlDocument.classList.contains("fp-switching")) modules_flsModules.fullpage.switchingSection(0);
            if (targetElement.closest(".section-1__body") || targetElement.classList.contains(".section-1__body")) modules_flsModules.fullpage.switchingSection(1);
            if (targetElement.closest(".page__next.next") || targetElement.classList.contains(".page__next.next")) {
                const nextSectionId = modules_flsModules.fullpage.nextSectionId;
                modules_flsModules.fullpage.switchingSection(nextSectionId);
            }
        }
